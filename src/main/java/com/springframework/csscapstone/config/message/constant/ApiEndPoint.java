...
public class ApiEndPoint {
    ...
    public static class Product {
        ...
        public static final String V3_PRODUCT_List_BY_ENTERPRISE_NOT_REGISTERED = v3_handler + "/list-not-registered-by";
        public static final String V3_PRODUCT_List_BY_ENTERPRISE_REGISTERED = v3_handler + "/list-registered-by";
    ...
    public static class Enterprise {
        ...
        public static final String V2_COLLABORATOR_COUNT = v2_handler + "/collabortor-count";
        public static final String V2_INFORMATION_POINT = v2_handler + "/point";
        public static final String V2_INFORMATION_REQUEST = v2_handler + "/number-request";
        public static final String V2_CAMPAIGN_COUNT = v2_handler + "/campaign";
    }
    ...
    public static class Account {
        ...
        public static final String V3_PROFILE_ACCOUNT = v3_handler + "/profile";
        public static final String V3_PROFILE_UPDATE_ACCOUNT = v3_handler + "/profile-update";
    ...
    public static class Order {
        ...
        public static final String V2_CHART_TOTAL = v2_handler + "/chart";
        public static final String V2_CHART_REVENUE = v2_handler + "/chart-revenue";
    ...
    public static class Prize {
        ...
        public static final String V2_PRIZE_DELETE = v2_handler + "/delete";
