...
import com.springframework.csscapstone.css_business.services.AccountService;
import com.springframework.csscapstone.css_business.model_dto.basic.AccountDto;
import com.springframework.csscapstone.css_business.model_dto.custom.creator_model.AccountRegisterDto;
import com.springframework.csscapstone.css_business.model_dto.custom.update_model.AccountUpdaterDto;
import com.springframework.csscapstone.css_data.domain.Account;
import com.springframework.csscapstone.css_data.domain.Account_;
...
import com.springframework.csscapstone.css_data.repositories.RoleRepository;
...
public class AccountServiceImpl implements AccountService {
    ...
    public List<AccountDto> getAllDto(String name, String phone,
        ...
        CriteriaQuery<Account> processQuery = query.where(builder.and(predicates.toArray(new Predicate[0])));
    ...
    public UUID registerAccount(AccountRegisterDto dto) throws AccountExistException {
        ...
        _checkDuplicationPredicate.test(repositories, dto);
