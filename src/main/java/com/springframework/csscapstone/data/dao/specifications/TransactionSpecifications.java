...
public class TransactionSpecifications {
    public static Specification<ApiEndPoint.Transaction> beforeDate(LocalDateTime beforeDate) {
        return (root, query, criteriaBuilder) -> criteriaBuilder
                .lessThan(root.get(Transactions_.CREATE_TRANSACTION), beforeDate);
    }

    public static Specification<ApiEndPoint.Transaction> afterDate(LocalDateTime afterDate) {
        return (root, query, criteriaBuilder) -> criteriaBuilder
